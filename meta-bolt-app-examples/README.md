...
```
bolt push <remote> com.rdkcentral.base+0.3.1                # here <remote> is the Hostname or alias of a device accessible via SSH in non-interactive mode

bolt push <remote> com.rdkcentral.wayland-egl-test+0.3.1
bolt push <remote> com.rdkcentral.wayland-egl-test-input+0.3.1
bolt push <remote> com.rdkcentral.wayland-egl-test-epoxy+0.3.1
bolt push <remote> com.rdkcentral.wayland-egl-test-input-epoxy+0.3.1

bolt run <remote> com.rdkcentral.wayland-egl-test+0.3.1
bolt run <remote> com.rdkcentral.wayland-egl-test-input+0.3.1
bolt run <remote> com.rdkcentral.wayland-egl-test-epoxy+0.3.1
bolt run <remote> com.rdkcentral.wayland-egl-test-input-epoxy+0.3.1
