...
```
bolt push <remote> com.rdkcentral.base+0.4.0                # here <remote> is the Hostname or alias of a device accessible via SSH in non-interactive mode

bolt push <remote> com.rdkcentral.wayland-egl-test+*
bolt push <remote> com.rdkcentral.wayland-egl-test-input+*
bolt push <remote> com.rdkcentral.wayland-egl-test-epoxy+*
bolt push <remote> com.rdkcentral.wayland-egl-test-input-epoxy+*

bolt run <remote> com.rdkcentral.wayland-egl-test+*
bolt run <remote> com.rdkcentral.wayland-egl-test-input+*
bolt run <remote> com.rdkcentral.wayland-egl-test-epoxy+*
bolt run <remote> com.rdkcentral.wayland-egl-test-input-epoxy+*
